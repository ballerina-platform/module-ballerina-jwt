...
InboundJwtAuthProvider jwtAuthProvider10_1 = new({
    issuer: "ballerina",
...
// Only `JwksConfig`
InboundJwtAuthProvider jwtAuthProvider10_2 = new({
    issuer: "ballerina",
    audience: "vEwzbcasJVQm1jVYHUHCjhxZ4tYa",
    jwksConfig: {
...
InboundJwtAuthProvider jwtAuthProvider10_3 = new({
    issuer: "ballerina",
    audience: "vEwzbcasJVQm1jVYHUHCjhxZ4tYa",
    jwksConfig: {
        url: "https://localhost:20199/oauth2/jwks",
...
InboundJwtAuthProvider jwtAuthProvider10_4 = new({
    issuer: "ballerina",
    audience: "vEwzbcasJVQm1jVYHUHCjhxZ4tYa"
});
